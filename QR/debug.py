...
def chat_driver(command, n_loops = 250):
            ...
            try:
                while True:
                    ...
                    if readed_qr:
                        ...
                        #     print("move left")
                        if (distance > 30) & (centroid[0] - 320 > 50):
                            chat_driver("#move right#[d]", n_loops = 500)
                            readed_qr = False
                            qr_cache = [None for _ in range(30)]
                            print("move forward")
                        elif (distance > 30) & (centroid[0] - 320 < -50):
                            chat_driver("#move left#[a]", n_loops = 500)
                            readed_qr = False
                            qr_cache = [None for _ in range(30)]
                            print("move forward and left")
                        elif ((centroid[0] - 320 > -50) & (centroid[0] - 320 < 50)):
                            if distance > 30:
                                chat_driver("#move forward#[w]", n_loops = 500)
                                readed_qr = False
                                qr_cache = [None for _ in range(30)]
                                print("move forward")
